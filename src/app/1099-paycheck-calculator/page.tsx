      ...
      <div className="c-wrap">
        ...
        <div className="faq">
          ...
          <div className="faq-q">
            ...
            <div className="faq-qa">Self-employment tax is 15.3% of net self-employment income: 12.4% Social Security (up to $176,100) + 2.9% Medicare. As a 1099 worker you pay both the employee and employer portions.</div>
          </div>
          <div className="faq-q">
