...
export default function SigningBonusClient() {
    ...
    <div style={BG}><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} />
      ...
      <div style={{ maxWidth:'900px', margin:'0 auto', padding:'32px 16px' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
            ...
            <div style={CARD}>
              ...
              <div style={{ marginTop:'12px', textAlign:'center' }}>
                <span style={{ fontSize:'13px', opacity: 0.8 }}>Effective Rate: </span>
        ...
        <div style={{ marginTop: "32px" }}>
          <LinkCardGrid title="Related Calculators" minCardWidth={150} links={[["/bonus-tax-calculator","Bonus Tax Calculator"],["/raise-calculator","Raise Calculator"],["/overtime-calculator","Overtime Calculator"],["/","Paycheck Calculator"]]} />
        </div>
      </div>
