...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color:'#c8d4e8', marginBottom: 12 }}><strong>No state income tax</strong> in Nevada — only federal income tax and FICA are withheld. Use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a> for your exact situation.</p>
      <div style={{ background: '#d4edda', color: '#1a1a2e', border: '1px solid #28a745', borderRadius: 8, padding: '12px 16px', marginBottom: 28, fontSize: 14 }}>No Nevada state income tax in 2026. Only federal withholding applies.</div>
      ...
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Does Nevada have state income tax?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>No. Nevada has no state income tax. Workers only pay federal income tax and FICA — same take-home as Texas and Florida.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $60,000 take-home in Nevada?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>A $60,000 salary in Nevada results in approximately $46,944/year ($3,912/month) after federal taxes and FICA.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Why do people move to Nevada for taxes?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>No state income tax, no inheritance tax, and relatively low property taxes make Nevada one of the most tax-friendly states for workers and retirees.</p>
      ...
      <div style={{ background: 'rgba(15,22,41,0.9)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: 12, padding: 'clamp(20px,4vw,28px) clamp(16px,4vw,28px)', marginBottom: 32 }}>
        <h2 style={{ fontSize: 'clamp(18px,4vw,22px)' as unknown as number, fontWeight: 800, color: '#f8fafc', marginBottom: 20, letterSpacing: '-0.3px', lineHeight: 1.3 }}>How Nevada Income Tax Works in 2026</h2>
        <ul style={{ margin: 0, paddingLeft: 0, listStyle: 'none', display: 'flex', flexDirection: 'column' as const, gap: 12, marginBottom: 20 }}>
          <li style={{ display: 'flex', gap: 12, alignItems: 'flex-start', fontSize: 'clamp(15px,2.5vw,16px)' as unknown as number, color: '#e2e8f0', lineHeight: 1.7 }}><span style={{ color: '#6366f1', fontWeight: 800, flexShrink: 0 }}>+</span><span>Nevada has no state income tax — workers keep more of every paycheck</span></li>
          ...
          <li style={{ display: 'flex', gap: 12, alignItems: 'flex-start', fontSize: 'clamp(15px,2.5vw,16px)' as unknown as number, color: '#e2e8f0', lineHeight: 1.7 }}><span style={{ color: '#6366f1', fontWeight: 800, flexShrink: 0 }}>+</span><span>This calculator uses 2026 IRS Publication 15-T tables and Nevada 2026 withholding rates</span></li>
        </ul>
        <h3 style={{ fontSize: 'clamp(16px,3vw,18px)' as unknown as number, fontWeight: 700, color: '#f8fafc', marginBottom: 10 }}>How much federal tax will I pay in Nevada?</h3>
        <p style={{ fontSize: 'clamp(15px,2.5vw,16px)' as unknown as number, color: '#b0c4de', lineHeight: 1.8, margin: 0 }}>Nevada has no state income tax, so your take-home pay is higher than in most states. You still owe federal income tax at 2026 IRS rates (10%–37% depending on income) plus FICA (7.65%). On a $60,000 salary, total withholding is roughly 18%–22%.</p>
      </div>
    </main>
  )
}
