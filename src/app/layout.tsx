...
<body suppressHydrationWarning style={{ margin: 0, padding: 0, overflowX:"hidden", maxWidth:"100%" }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        <main role="main"><div style={{background:'rgba(34,197,94,0.1)',border:'1px solid rgba(34,197,94,0.2)',color:'#22c55e',padding:'6px 14px',borderRadius:'20px',display:'inline-flex',alignItems:'center',gap:'8px',fontSize:'13px',fontWeight:700,margin:'15px 0',borderLeft:'4px solid #22c55e'}}><span>✓</span> 2026 IRS Guidance Compliant</div>
