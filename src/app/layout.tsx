...
export const metadata: Metadata = {
  ...
  description: 'Free paycheck, overtime, unemployment & minimum wage calculators for all 50 US states. Federal + state taxes, FICA, 401k, HSA. 100% private – your data never leaves your browser.',
