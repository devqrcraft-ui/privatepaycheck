...
export const metadata: Metadata = {
  title: '$75,000 a Year After Taxes 2026 — Monthly & Hourly Take-Home',
...
export default function Page() {
  ...
  return (
    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $75,000 a year after taxes in 2026?</h3><p style={{ color: '#c8d0e7', lineHeight: 1.7 }}>$75k gross. In Texas: ~$56,124/year ($4,677/month). In California: ~$52,500/year ($4,375/month). In New York: ~$49,716/year.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $75k a year per hour after taxes?</h3><p style={{ color: '#c8d0e7', lineHeight: 1.7 }}>$75,000 ÷ 2,080 hours = $36.06/hr gross. After taxes in Texas: ~$26.98/hr effective. In California: ~$25.24/hr.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Is $75,000 a good salary in 2026?</h3><p style={{ color: '#c8d0e7', lineHeight: 1.7 }}>$75k is above the US median household income and provides a comfortable lifestyle in most states. In high cost-of-living cities like NYC or San Francisco, it is lower-middle class.</p>
