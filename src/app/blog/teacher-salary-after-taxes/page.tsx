    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ background: 'rgba(245,200,66,0.08)', border: '1px solid rgba(245,200,66,0.25)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
        <p style={{ margin: 0, fontSize: '15px', lineHeight: 1.75, color: '#e8edf8' }}>
          <strong style={{ color: '#F5C842' }}>Quick answer:</strong> Teacher salary after taxes 2026: median gross ~$62,000/year. Take-home = <strong style={{color:"#fff"}}>$47,000–$50,200/year</strong> ($3,917–$4,183/month). Pension contributions are pre-tax. Teachers in no-income-tax states keep $2,000–$3,500 more annually.
        </p>
      </div>
      <p style={{ fontSize: 17, color: '#c8d0e7', marginBottom: 32 }}>The national average teacher salary is <strong>$68,000/year</strong> in 2026. After federal taxes, FICA, and state taxes, most teachers take home $46,000–$54,000 — before pension deductions which can be another 7%–10%. Use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a> for your exact situation.</p>
