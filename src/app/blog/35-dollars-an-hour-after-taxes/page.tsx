    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div className="answer-first" style={{ background: 'rgba(245,200,66,0.08)', border: '1px solid rgba(245,200,66,0.25)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
        <p style={{ margin: 0, fontSize: '15px', lineHeight: 1.75, color: '#e8edf8' }}>
          <strong style={{ color: '#F5C842' }}>Quick answer:</strong> $35/hour after taxes = <strong style={{color:"#fff"}}>~$54,600–$60,900/year</strong> take-home ($4,550–$5,075/month). Gross: $72,800/year. Federal effective rate ~15–18%, FICA 7.65%.
        </p>
      </div>
      ...
      <p style={{ fontSize: 17, color: '#c8d0e7', marginBottom: 32 }}><strong>$72,800/year gross</strong>. Take-home varies by state — see exact numbers below or use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a>.</p>
      ...
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $35 an hour after taxes?</h3><p style={{ color: '#c8d0e7', lineHeight: 1.7 }}>$35/hr = $72,800/year gross. Take-home in Texas: ~$60,516/year ($29.09/hr). In California: ~$54,132/year.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Is $35 an hour middle class?</h3><p style={{ color: '#c8d0e7', lineHeight: 1.7 }}>Yes. $72,800/year is solidly middle class nationwide and above median in most states. It covers a comfortable lifestyle outside major metros.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $35/hr biweekly after taxes?</h3><p style={{ color: '#c8d0e7', lineHeight: 1.7 }}>$35 × 80 hours = $2,800 gross biweekly. After taxes in Texas: approximately $2,328 net per paycheck.</p>
