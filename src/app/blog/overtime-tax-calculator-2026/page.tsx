...
export default function Post() {
  ...
  return (
    ...
    <main style={{ background:bg, minHeight:'100vh', color:'#e8edf8', fontFamily:'system-ui,sans-serif' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BlogPosting","headline":"Overtime Tax Calculator 2026","url":"https://privatepaycheck.com/blog/overtime-tax-calculator-2026","datePublished":"2026-05-13","dateModified":"2026-05-13","author":{"@type":"Person","name":"Ethan Blake","jobTitle":"Tax Compliance Specialist","sameAs":["https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center"]},"publisher":{"@type":"Organization","name":"PrivatePaycheck","url":"https://privatepaycheck.com"}}) }} />
