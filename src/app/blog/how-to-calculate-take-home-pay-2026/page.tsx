...
export const metadata: Metadata = {
  title: 'How to Calculate Your Take-Home Pay in the US (2026)',
    ...
    <main style={{ minHeight:'100vh', background:'#091526', color:'white', fontFamily:'system-ui,sans-serif' }}>
      ...
      <div className="answer-first" style={{ background: 'rgba(245,200,66,0.08)', border: '1px solid rgba(245,200,66,0.25)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
        <p style={{ margin: 0, fontSize: '15px', lineHeight: 1.75, color: '#e8edf8' }}>
          <strong style={{ color: '#F5C842' }}>Quick answer:</strong> Take-home pay 2026 formula: Gross pay − federal income tax − FICA (7.65%) − state tax − local tax − pre-tax deductions. On $70,000/year gross: federal tax ~$8,200 + FICA ~$5,355 + state tax (varies) = take-home of <strong style={{color:"#fff"}}>$52,500–$56,000</strong>.
        </p>
      </div>
        ...
        <div style={{ fontSize:'16px', lineHeight:2, opacity:0.88 }}>
          ...
          <div style={{ overflowX:'auto', marginBottom:16 }}>
            <table style={{ width:'100%', borderCollapse:'collapse', minWidth:400, fontSize:14 }}>
              ...
              <tbody>
                {[['$0 – $12,400','10%'],['$12,401 – $50,400','12%'],['$50,401 – $105,700','22%'],['$105,701 – $201,775','24%'],['$201,776 – $256,225','32%'],['$256,226 – $640,600','35%'],['Over $640,600','37%']].map(([r,t])=>(
