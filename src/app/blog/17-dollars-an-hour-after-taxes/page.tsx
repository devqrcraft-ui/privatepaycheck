...
export const metadata: Metadata = {
  title: '$17 an Hour After Taxes 2026 — Take-Home Pay by State',
  ...
  return (
    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ background: '#1a2550', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate exact take-home for $17/hr →</a>
      </div>
