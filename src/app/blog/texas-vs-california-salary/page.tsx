...
export default function Post(){return(<main style={{minHeight:'100vh',background:'#091526',color:'white',fontFamily:'system-ui,sans-serif'}}><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({'@context':'https://schema.org','@type':'BlogPosting',headline:'Texas vs California Salary 2026',url:'https://www.privatepaycheck.com/blog/texas-vs-california-salary',datePublished:'2026-02-22',author:{'@type':'Person','name':'Ethan Blake','jobTitle':'Tax Compliance Specialist','sameAs':['https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center']},'reviewedBy':{'@type':'Person','name':'Ethan Blake','jobTitle':'Tax Compliance Specialist','sameAs':['https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center']},'publisher':{'@type':'Organization','name':'PrivatePaycheck','url':'https://www.privatepaycheck.com'}})}}/>
...
<blockquote style={{borderLeft:"3px solid rgba(245,200,66,0.4)",paddingLeft:16,margin:"20px 0",fontStyle:"italic",color:"rgba(255,255,255,0.7)",fontSize:14,lineHeight:1.8}}>{"The Internal Revenue Service requires self-employed individuals and freelancers to pay estimated taxes quarterly if they expect to owe at least $1,000 in federal tax for the year."}<cite style={{display:"block",marginTop:8,fontSize:12,color:"rgba(255,255,255,0.45)",fontStyle:"normal"}}>{"— "}<a href="https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center" rel="nofollow" target="_blank" style={{color:"#F5C842"}}>IRS.gov — Self-Employed Tax Center</a></cite></blockquote><AuthorBox /></main>);}
