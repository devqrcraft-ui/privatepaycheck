    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ background: 'rgba(245,200,66,0.08)', border: '1px solid rgba(245,200,66,0.25)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
        <p style={{ margin: 0, fontSize: '15px', lineHeight: 1.75, color: '#e8edf8' }}>
          <strong style={{ color: '#F5C842' }}>Quick answer:</strong> Nurse take-home pay 2026: RN median salary ~$82,000/year. After federal tax, FICA (7.65%), and state tax, take-home is approximately <strong style={{color:"#fff"}}>$60,500–$65,000/year</strong> ($4,625–$4,990/month). Travel nurses in no-income-tax states keep $3,000–$5,000 more/year.
        </p>
      </div>
      <p style={{ fontSize: 17, color: '#c8d0e7', marginBottom: 32 }}>The average RN salary is <strong>$77,600/year</strong> ($37.31/hr) in 2026. After federal taxes and FICA — and state taxes that vary dramatically — take-home ranges from $55,000 to $62,000. Use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a> for your exact situation.</p>
