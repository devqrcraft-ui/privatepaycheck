    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ background: 'rgba(245,200,66,0.08)', border: '1px solid rgba(245,200,66,0.25)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
        <p style={{ margin: 0, fontSize: '15px', lineHeight: 1.75, color: '#e8edf8' }}>
          <strong style={{ color: '#F5C842' }}>Quick answer:</strong> Police officer salary after taxes 2026: median gross ~$67,000/year. Take-home = <strong style={{color:"#fff"}}>$50,500–$54,000/year</strong> ($4,208–$4,500/month). Officers in TX/FL keep ~$3,000 more/year than CA. Pension contributions further reduce taxable income.
        </p>
      </div>
