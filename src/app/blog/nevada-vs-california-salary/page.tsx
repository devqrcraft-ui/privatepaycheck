...
export default function Page() {
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <nav style={{ fontSize: 13, color: '#666', marginBottom: 24 }}><a href="/" style={{ color: '#666' }}>Home</a> › <a href="/blog" style={{ color: '#666' }}>Blog</a> › Nevada vs California Salary</nav>
      <h1 style={{ fontSize: 34, fontWeight: 900, marginBottom: 8 }}>Nevada vs California Salary 2026</h1>
      <p style={{ fontSize: 17, color: '#444', marginBottom: 32 }}>Nevada has <strong>no state income tax.</strong> California has up to <strong>13.3%.</strong> Here is the exact take-home difference at every income level.</p>
      <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 32 }}>
        ...
        <tbody>{[
          ...
          <tr key={s} style={{ borderBottom: '1px solid #eee' }}>
            ...
            <td style={{ padding: '10px 14px', fontWeight: 700, color: '#1a56db' }}>{nv}</td>
      ...
      <div style={{ background: '#f0f4ff', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color: '#1a56db', fontWeight: 700 }}>Calculate your NV vs CA take-home →</a>
      </div>
