...
export const metadata: Metadata = {
  title: '$70,000 a Year After Taxes 2026 — Monthly & Hourly Take-Home',
  ...
  return (
    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ background: '#1a2550', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate your exact $70k take-home →</a>
      </div>
