...
export default function Page() {
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <nav style={{ fontSize: 13, color: '#666', marginBottom: 24 }}><a href="/" style={{ color: '#666' }}>Home</a> › <a href="/blog" style={{ color: '#666' }}>Blog</a> › Florida vs New York Salary</nav>
      <h1 style={{ fontSize: 34, fontWeight: 900, marginBottom: 8 }}>Florida vs New York Salary 2026</h1>
      <p style={{ fontSize: 17, color: '#444', marginBottom: 32 }}>Florida has <strong>no state income tax.</strong> New York has up to <strong>10.9% state + 3.876% NYC tax.</strong> Here is exactly how much more you keep in Florida at every salary level.</p>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 32 }}>
        ...
        <tbody>{[
          ...
          <tr key={s} style={{ borderBottom: '1px solid #eee' }}>
            ...
            <td style={{ padding: '10px 14px', color: '#888' }}>{ny}</td>
