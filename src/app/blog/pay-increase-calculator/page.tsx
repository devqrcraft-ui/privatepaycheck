        ...
        <div style={{ fontSize: '15px', lineHeight: 1.9, opacity: 0.85 }}>
          ...
          <div style={{ overflowX: 'auto', marginBottom: 24, borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
              ...
              <tbody>
                {[
                  ['10%','Up to $12,400','Up to $24,800','Keep $9,000'],
                  ['12%','$12,401-$50,400','$24,801-$100,800','Keep $8,800'],
                  ['22%','$50,401-$105,700','$100,801-$211,400','Keep $7,800'],
                  ['24%','$105,701-$201,775','$211,401-$403,550','Keep $7,600'],
                  ['32%','$201,776-$256,225','$403,551-$512,450','Keep $6,800'],
                  ['37%','Over $640,600','Over $768,700','Keep $6,300'],
