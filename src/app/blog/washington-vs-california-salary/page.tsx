...
export default function Page() {
  return (
    ...
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://privatepaycheck.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://privatepaycheck.com/blog"},{"@type":"ListItem","position":3,"name":"Washington vs California Salary 2026 — Take-Home Pay Comparison","item":"https://privatepaycheck.com/blog/washington-vs-california-salary"}]}` }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BlogPosting","headline":"Washington vs California Salary 2026 — Take-Home Pay Comparison","description":"Washington state vs California salary after taxes 2026. At $100k, WA residents keep $5,016 more per year. See full comparison at every salary level.","url":"https://privatepaycheck.com/blog/washington-vs-california-salary","datePublished":"2026-01-01","dateModified":"2026-05-12","author":{"@type":"Organization","name":"the PrivatePaycheck Team","url":"https://www.privatepaycheck.com"},"reviewedBy":{"@type":"Organization","name":"the PrivatePaycheck Team","url":"https://www.privatepaycheck.com"},"publisher":{"@type":"Organization","name":"PrivatePaycheck","url":"https://privatepaycheck.com"}}` }} />
      ...
      <div className="answer-first" style={{ background: 'rgba(245,200,66,0.08)', border: '1px solid rgba(245,200,66,0.25)', borderRadius: '10px', padding: '16px 20px', marginBottom: '24px' }}>
        <p style={{ margin: 0, fontSize: '15px', lineHeight: 1.75, color: '#e8edf8' }}>
          <strong style={{ color: '#F5C842' }}>Quick answer:</strong> Washington vs California salary: on $100,000/year, Washington residents take home <strong style={{color:"#fff"}}>~$76,000</strong> vs California ~$69,000. Washington has no state income tax — saving $6,000–$8,000/year vs California's 9.3% rate.
        </p>
      </div>
      ...
      <p style={{ fontSize: 17, color: '#c8d0e7', marginBottom: 32 }}>Washington has <strong>no state income tax.</strong> California has up to <strong>13.3% state income tax.</strong> Here is exactly how much more you keep in Washington at every salary level.</p>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 32 }}>
        ...
        <tbody>{[
          ...
          <tr key={s} style={{ borderBottom: '1px solid #1e2d5a' }}>
            ...
            <td style={{ padding: '10px 14px', fontWeight: 700, color:'#F5C842' }}>{wa}</td>
      ...
      <div style={{ background: '#1a2550', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate your exact WA vs CA take-home →</a>
      </div>
