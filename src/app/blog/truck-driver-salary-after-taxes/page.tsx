...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <nav style={{ fontSize: 13, color: '#666', marginBottom: 24 }}><a href="/" style={{ color: '#666' }}>Home</a> › <a href="/blog" style={{ color: '#666' }}>Blog</a> › Truck Driver Salary After Taxes</nav>
      <h1 style={{ fontSize: 34, fontWeight: 900, marginBottom: 8 }}>Truck Driver Salary After Taxes 2026</h1>
      <p style={{ fontSize: 17, color: '#444', marginBottom: 32 }}>OTR truck drivers average <strong>$70,000/year</strong> in 2026. After taxes, take-home is <strong>$47,736–$53,424</strong> depending on state — before per diem deductions which can add $8,000–$15,000 back.</p>
