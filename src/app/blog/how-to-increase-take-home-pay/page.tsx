...
export default function Post(){return(<main style={{minHeight:'100vh',background:'#091526',color:'white',fontFamily:'system-ui,sans-serif'}}><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({'@context':'https://schema.org','@type':'BlogPosting',headline:'7 Ways to Increase Your Take-Home Pay in 2026 (Without a Raise)',url:'https://privatepaycheck.com/blog/how-to-increase-take-home-pay',datePublished:'2026-02-25',author:{'@type':'Organization',name:'PrivatePaycheck'}})}}/>
