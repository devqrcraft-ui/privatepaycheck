...
export default function Post(){return(<main style={{minHeight:'100vh',background:'linear-gradient(135deg,#0f0c29,#302b63,#24243e)',color:'white',fontFamily:'system-ui,sans-serif'}}><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({'@context':'https://schema.org','@type':'BlogPosting',headline:'7 Ways to Increase Your Take-Home Pay in 2026 (Without a Raise)',url:'https://www.privatepaycheck.com/blog/how-to-increase-take-home-pay',datePublished:'2026-02-25',author:{'@type':'Organization',name:'PrivatePaycheck'}})}}/>
