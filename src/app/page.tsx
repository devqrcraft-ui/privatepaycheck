...
export default function Page() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"PrivatePaycheck — Paycheck Calculator","url":"https://www.privatepaycheck.com","description":"Free paycheck calculator for all 50 US states. Calculate take-home pay after federal, state, FICA taxes. Salary and hourly. 2026 IRS brackets.","applicationCategory":"FinanceApplication","operatingSystem":"Any","browserRequirements":"Requires JavaScript","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","ratingCount":"892","bestRating":"5","worstRating":"1"}}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebSite","name":"PrivatePaycheck","url":"https://privatepaycheck.com","potentialAction":{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://privatepaycheck.com/blog?q={search_term_string}"},"query-input":"required name=search_term_string"}}' }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"Person","name":"Ethan Blake","jobTitle":"Tax Compliance Specialist","description":"Tax compliance specialist since 2017. Helped 5,000+ freelancers navigate IRS rules.","sameAs":["https://www.irs.gov/businesses/small-businesses-self-employed/self-employed-individuals-tax-center","https://www.gov.uk/self-assessment-tax-returns"]}' }} />
      <HomeClient />
    </>
  );
}
