...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif', color: '#e2e8f0', background: '#0f1629', minHeight: '100vh' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.privatepaycheck.com"},{"@type":"ListItem","position":2,"name":"New York Paycheck Calculator","item":"https://www.privatepaycheck.com/new-york-paycheck-calculator"}]}' }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebPage","name":"New York Paycheck Calculator","datePublished":"2026-01-15","dateModified":"2026-06-11","author":{"@type":"Organization","name":"the PrivatePaycheck Team","url":"https://www.privatepaycheck.com"},"publisher":{"@type":"Organization","name":"PrivatePaycheck","url":"https://www.privatepaycheck.com"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://www.privatepaycheck.com/new-york-paycheck-calculator"}}' }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"HowTo","name":"How to Calculate Your New York Paycheck in 2026","description":"Step-by-step guide to calculating take-home pay for New York workers in 2026.","step":[{"@type":"HowToStep","position":1,"name":"Enter your gross salary","text":"Start with your annual or hourly gross pay before any deductions."},{"@type":"HowToStep","position":2,"name":"Subtract federal income tax","text":"Apply 2026 IRS tax brackets (10%-37%) based on filing status and standard deduction of $16,100 single / $32,200 MFJ."},{"@type":"HowToStep","position":3,"name":"Subtract FICA taxes","text":"Deduct Social Security (6.2% up to $184,500) and Medicare (1.45%) from gross pay."},{"@type":"HowToStep","position":4,"name":"Subtract New York state tax","text":"Apply New York state income tax rates for 2026 to your taxable income."},{"@type":"HowToStep","position":5,"name":"Calculate net take-home pay","text":"Subtract all deductions from gross pay to get your New York take-home pay per paycheck."}]}' }} />
