...
export const metadata: Metadata = {
  title: 'California Paycheck Guide 2026 2026 — PrivatePaycheck',
  description: 'Understanding CA SDI, state tax, and local rules.',
  alternates: { canonical: 'https://www.privatepaycheck.com/california-paycheck-guide' }
};
...
export default function HubPage() {
  return (
    <div className="max-w-4xl mx-auto p-8" style={color: '#333', background: '#fff', minHeight: '100vh'}>
      ...
      <h1 className="text-4xl font-bold mb-6 text-slate-900">California Paycheck Guide 2026</h1>
      <p className="text-xl mb-8 text-slate-600">Understanding CA SDI, state tax, and local rules.</p>
      <div className="prose prose-slate max-w-none text-lg">
        <p>California payroll includes SDI (State Disability Insurance) and progressive state brackets. We handle it all.</p>
      </div>
      <div className="mt-12 p-8 rounded-2xl border border-blue-100 bg-blue-50 shadow-sm">
        <h3 className="text-2xl font-bold mb-3 text-slate-900">Calculate Your California Paycheck</h3>
