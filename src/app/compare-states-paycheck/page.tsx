...
export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 20px', fontFamily: 'system-ui,sans-serif', color: '#e2e8f0', background: '#0f0c29', minHeight: '100vh' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"WebPage","name":"Compare States Paycheck","datePublished":"2026-01-15","dateModified":"2026-06-11","author":{"@type":"Person","name":"Ethan Blake","url":"https://medium.com/@dev.qrcraft"},"publisher":{"@type":"Organization","name":"PrivatePaycheck","url":"https://www.privatepaycheck.com"},"mainEntityOfPage":{"@type":"WebPage","@id":"https://www.privatepaycheck.com/compare-states-paycheck"}}' }} />
