...
export default function Page() {
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      <nav style={{ fontSize: 13, color: '#666', marginBottom: 24 }}><a href="/" style={{ color: '#666' }}>Home</a> › Methodology</nav>
      <h1 style={{ fontSize: 34, fontWeight: 900, marginBottom: 8 }}>How We Calculate Paycheck Take-Home Pay</h1>
      <p style={{ fontSize: 17, color: '#444', marginBottom: 32 }}>All calculations on PrivatePaycheck use official 2026 IRS and state tax authority data. Every formula runs entirely in your browser — we never see your numbers.</p>

      <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Data Sources</h2>
      <ul style={{ color: '#444', lineHeight: 2, paddingLeft: 20, marginBottom: 32 }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 32 }}>
        ...
        <tbody>{[
          ...
          <tr key={r} style={{ borderBottom: '1px solid #eee' }}>
            <td style={{ padding: '10px 14px', fontWeight: 700, color: '#1a56db' }}>{r}</td>
