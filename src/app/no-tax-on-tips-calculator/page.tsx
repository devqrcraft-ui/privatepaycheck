    ...
    <main style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '40px 16px' }}>
          ...
          {result && (
            <div style={{ marginTop: '28px', padding: '28px', background: 'rgba(74,222,128,0.07)', border: '1px solid rgba(74,222,128,0.25)', borderRadius: '16px' }}>
              ...
              <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.35)', margin: 0, lineHeight: 1.6 }}>
                ✓ Federal income tax only. SS (6.2%) + Medicare (1.45%) still apply to tips. Valid 2025–2028.
              </p>
            </div>
          )}
        </div>
        ...
        {[
          ...
          { q: 'Does "No Tax on Tips" mean tips are completely tax-free?', a: 'Federal income tax only — not all taxes. You still pay Social Security (6.2%) and Medicare (1.45%) on tips, and your state may tax them too. But the federal savings alone can be $1,500–$5,500/year for a typical tipped worker earning $20K in tips.' },
          { q: 'When does this law take effect?', a: 'Tips earned January 1, 2025 through December 31, 2028. You claim it on your 2025 tax return filed in early 2026. Tips earned in 2024 are still fully taxable as before.' },
          { q: 'Can I take this AND the standard deduction?', a: 'Yes! It is an above-the-line deduction — subtracted before your AGI is calculated. Works whether you itemize or take the standard deduction. This is a major advantage.' },
          { q: 'What if my income exceeds $150,000?', a: 'The deduction phases out at $100 per $1,000 above $150,000 (single) or $300,000 (joint). Above $400,000 (single) the deduction is fully eliminated.' },
          { q: 'Do I need to keep records of my tips?', a: 'Yes. You must report tips to your employer and keep your own records. Cash tips, credit card tips, and tip-pools all qualify if documented. The IRS can audit tip income.' },
        ].map(({ q, a }) => (
