...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color:'#c8d4e8', marginBottom: 12 }}>Kentucky state income tax: <strong>4% flat</strong>. See your exact take-home below. Use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a> for your exact situation.</p>
      ...
      <div style={{ background: 'rgba(99,102,241,0.2)', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate your exact Kentucky paycheck →</a>
      </div>
      <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Frequently Asked Questions</h2>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>What is Kentucky income tax rate 2026?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Kentucky has a flat 4% income tax rate in 2026, reduced from 4.5%.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $50,000 take-home in Kentucky?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Approximately $38,544/year ($3,212/month) after federal, FICA, and KY state tax.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Does Kentucky have local income taxes?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Yes. Louisville and other Kentucky cities levy local occupational taxes typically ranging from 1% to 2.5%.</p>
