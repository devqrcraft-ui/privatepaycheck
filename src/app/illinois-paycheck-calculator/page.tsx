...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif', color: '#e2e8f0', background: '#0f1629', minHeight: '100vh' }}>
      ...
      <FreshnessBar state="Illinois" items={["IL flat income tax: 4.95% (unchanged 2026)","Federal SS wage base: $184,500 for 2026","Chicago residents: additional 1.25% city tax","IL minimum wage: $15/hr (Jan 2025)"]} />
