...
export default function W4Calculator(){
  ...
  return(
    <main style={{minHeight:'100vh',background:'#091526',color:'white',fontFamily:'system-ui,sans-serif'}}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I fill out a W-4 in 2026?","acceptedAnswer":{"@type":"Answer","text":"Complete Step 1 (personal info), Step 2 (multiple jobs), Step 3 (dependents/credits), Step 4 (other income/deductions/extra withholding), and Step 5 (signature). Use the IRS Tax Withholding Estimator or our calculator to determine the right extra withholding amount in Step 4(c)."}},{"@type":"Question","name":"How much should I withhold on my W-4?","acceptedAnswer":{"@type":"Answer","text":"Aim to withhold enough to cover your tax liability without a large refund or bill. If you have one job and no major deductions, the default W-4 settings are usually accurate. If you have multiple jobs, side income, or itemize deductions, adjust Step 4 accordingly."}},{"@type":"Question","name":"What happens if I claim too many allowances on my W-4?","acceptedAnswer":{"@type":"Answer","text":"Under-withholding means you owe taxes at filing and may face an underpayment penalty if you owe more than <main style={{minHeight:'100vh',background:'#091526',color:'white',fontFamily:'system-ui,sans-serif'}}>,000. The IRS can also flag your account. Use our W-4 calculator to verify your withholding is correct for 2026."}}]}' }} />
