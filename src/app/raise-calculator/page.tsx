...
export const metadata: Metadata = {
  ...
  description: 'Calculate your new paycheck after a raise. See federal + state tax impact on your salary increase. All 50 states. Free, instant.',
...
const INPUT_S = { width:'100%', background:'#1e2a4a', border:'1px solid rgba(255,255,255,0.15)', borderRadius:'10px', padding:'12px 14px', color:'#fff', fontSize:'16px', boxSizing:'border-box' as const, outline:'none', colorScheme:'dark' };
          ...
          <div style={CARD}>
            ...
            <div style={{ marginBottom:'16px', marginTop:'12px' }}>
              ...
              <div style={{ position:'relative' }}>
                ...
                <input type="number" value={raise} onChange={e=>setRaise(Math.max(0,+e.target.value))} min={0} step={raiseType==='pct'?0.5:500} style={{ ...INPUT_S, paddingLeft:'28px' }} />
              </div>
            </div>
