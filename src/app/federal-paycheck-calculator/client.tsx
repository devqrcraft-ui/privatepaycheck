      ...
      <div className="fw">
        ...
        <div className="tax-pills">
          ...
          <div className="tax-pill">
            ...
            <div className="pill-sub">Up to $176,100</div>
          </div>
          <div className="tax-pill">
          ...
          <div className="tax-pill">
            ...
            <div className="pill-val">$14,600</div>
            <div className="pill-sub">Single · $29,200 MFJ</div>
          </div>
        </div>
        ...
        <div className="faq">
          ...
          <div className="faq-q">
            ...
            <div className="faq-qa">Two federal taxes: federal income tax (10%–37% based on brackets and filing status) and FICA (Social Security 6.2% up to $176,100 + Medicare 1.45% on all wages). State taxes are separate.</div>
          </div>
          <div className="faq-q">
            <div className="faq-qt">What is the 2026 standard deduction?</div>
            <div className="faq-qa">$14,600 for Single · $29,200 for Married Filing Jointly · $21,900 for Head of Household. Subtracted from annualized wages before applying brackets.</div>
          </div>
          <div className="faq-q">
          ...
          <div className="faq-q">
            ...
            <div className="faq-qa">$176,100. You pay 6.2% on wages up to this limit. Above $176,100 no Social Security tax applies, but Medicare (1.45%) continues with no cap.</div>
          </div>
          <div className="faq-q">
