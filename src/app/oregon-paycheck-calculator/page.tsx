...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color:'#c8d4e8', marginBottom: 12 }}>Oregon state income tax: <strong>up to 9.9%</strong>. See your exact take-home below. Use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a> for your exact situation.</p>
      ...
      <div style={{ background: 'rgba(99,102,241,0.2)', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate your exact Oregon paycheck →</a>
      </div>
      <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Frequently Asked Questions</h2>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>What is Oregon income tax rate 2026?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Oregon top income tax rate is 9.9% in 2026.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $60,000 take-home in Oregon?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Approximately $41,172/year ($3,431/month) after federal, FICA, and OR state tax.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Does Oregon have sales tax?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>No. Oregon has no sales tax, which partially offsets the high income tax rates.</p>
