  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif', color: '#e2e8f0', background: '#0f1629', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'rgba(99,102,241,0.2)', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate your exact Massachusetts paycheck →</a>
      </div>
      <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Frequently Asked Questions</h2>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>What is Massachusetts income tax rate 2026?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Massachusetts has a flat 5% income tax rate, plus an additional 4% surtax on income over $1 million.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $60,000 take-home in Massachusetts?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Approximately $43,992/year ($3,666/month) after federal, FICA, and 5% MA state tax.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Does Massachusetts have a millionaire tax?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Yes. Income over $1 million is taxed at 9% total (5% + 4% surtax) in Massachusetts.</p>
