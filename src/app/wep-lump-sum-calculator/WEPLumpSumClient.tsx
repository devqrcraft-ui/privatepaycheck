      ...
      <div style={{ maxWidth:600, margin:'0 auto' }}>
        ...
        <div style={{ background:'rgba(255,255,255,0.05)', borderRadius:16, padding:24, marginBottom:20 }}>
          ...
          <div style={{ position:'relative' }}>
            ...
            <input type="number" value={pension} onChange={e=>setPension(e.target.value)} min={0} style={{ ...inp, paddingLeft:28 }} />
          </div>
          ...
          <div style={{ position:'relative' }}>
            ...
            <input type="number" value={lumpSum} onChange={e=>setLumpSum(e.target.value)} min={0} style={{ ...inp, paddingLeft:28 }} />
          </div>
          ...
          <div style={{ position:'relative' }}>
            <span style={{ position:'absolute', left:14, top:'50%', transform:'translateY(-50%)', color:'#4ade80', fontWeight:700 }}>$</span>
            <input type="number" value={newSS} onChange={e=>setNewSS(e.target.value)} min={0} style={{ ...inp, paddingLeft:28 }} />
          </div>
