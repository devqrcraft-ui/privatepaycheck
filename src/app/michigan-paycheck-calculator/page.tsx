    ...
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif', background: '#0f0c29', minHeight: '100vh', color: 'white' }}>
      ...
      <div style={{background:'rgba(245,200,66,0.08)',border:'1px solid rgba(245,200,66,0.25)',borderRadius:8,padding:'16px 20px',marginBottom:28}}>
        ...
        <ul style={{margin:0,padding:'0 0 0 18px',fontSize:14,lineHeight:1.9,color:'rgba(255,255,255,0.85)'}}>
          <li>Michigan flat income tax rate is <strong>4.25%</strong> in 2026</li>
          <li>At $50,000 salary, take-home is approximately <strong>$3,120/month</strong> after federal, FICA, and MI state tax</li>
          <li>Detroit residents pay an additional <strong>2.4%</strong> city income tax (1.2% for non-residents)</li>
          <li>Michigan personal exemption is <strong>$5,600</strong> per person for 2026</li>
          <li>Social Security income is <strong>partially taxed</strong> in Michigan depending on birth year</li>
        </ul>
      </div>
