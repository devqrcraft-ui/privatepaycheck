...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '48px 24px', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <p style={{ fontSize: 17, color:'#c8d4e8', marginBottom: 12 }}>Michigan state income tax: <strong>4.05% flat</strong>. See your exact take-home below. Use the <a href="/" style={{ color:'#F5C842' }}>free calculator</a> for your exact situation.</p>
      ...
      <div style={{ background: 'rgba(99,102,241,0.2)', borderRadius: 8, padding: 20, marginBottom: 32 }}>
        <a href="/" style={{ color:'#F5C842', fontWeight: 700 }}>Calculate your exact Michigan paycheck →</a>
      </div>
      <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Frequently Asked Questions</h2>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>What is Michigan state income tax rate in 2026?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Michigan has a flat 4.05% income tax rate in 2026 (reduced from 4.25%).</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>How much is $50,000 take-home in Michigan?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Approximately $38,496/year ($3,208/month) after federal, FICA, and 4.05% MI state tax.</p>
      <h3 style={{ fontSize: 17, fontWeight: 700, marginTop: 20 }}>Do Michigan cities have income tax?</h3><p style={{ color:'#c8d4e8', lineHeight: 1.7 }}>Yes. Detroit levies 2.4% for residents (1.2% for non-residents). Other cities like Grand Rapids and Lansing have smaller local taxes.</p>
