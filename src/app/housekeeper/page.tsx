...
export const metadata: Metadata = {
  ...
  description: 'Calculate housekeeper taxes (FICA, FUTA) with the 2026 $3,000 threshold and new Overtime Tax Exemption. 100% free, no signup required.',
...
export default function HousekeeperPage() {
  const schemaJson = {
    ...
    '@type': 'WebApplication',
    name: 'Housekeeper Tax Calculator 2026',
    url: 'https://www.privatepaycheck.com/housekeeper',
    description: 'Free housekeeper tax calculator for household employers. FICA, FUTA, and 2026 overtime exemption.',
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6" style={{ color: '#333' }}>
        ...
        <HouseholdCalculator roleLabel="Housekeeper" />
