...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const descriptionOverrides: Record<string, string> = {
    ...
    'new-york':     'New York unemployment calculator 2026: max $504/week for 26 weeks. State tax 6.85%. Estimate your weekly benefit instantly.',
    'florida':      'Florida unemployment calculator 2026: max $275/week for 12 weeks only. No state income tax. Calculate your exact benefit.',
  ...
  return {
    title: data.name + ' Unemployment Calculator',
