...
export default function NoTaxOnOvertimePage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#091526', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How does no tax on overtime work in 2026?","acceptedAnswer":{"@type":"Answer","text":"The proposed No Tax on Overtime policy would exempt overtime wages from federal income tax. Currently overtime is taxed as regular income. If passed, workers earning overtime would keep significantly more per paycheck — an estimated <main style={{ minHeight: '100vh', background: '#091526', color: 'white', fontFamily: 'system-ui,sans-serif' }}>,200-$3,000/year for full-time hourly workers."}},{"@type":"Question","name":"Is overtime tax-free in 2026?","acceptedAnswer":{"@type":"Answer","text":"Not yet as of 2026. No Tax on Overtime has been proposed but not enacted into law. Currently, all overtime pay is subject to federal income tax, FICA (Social Security + Medicare), and state income tax where applicable."}},{"@type":"Question","name":"How much more would I earn if overtime was tax-free?","acceptedAnswer":{"@type":"Answer","text":"On <main style={{ minHeight: '100vh', background: '#091526', color: 'white', fontFamily: 'system-ui,sans-serif' }}>0,000 in annual overtime at the 22% federal bracket, eliminating federal income tax would save roughly $2,200/year. Add state tax savings in high-tax states like California and the total could reach $3,000-$4,000 annually."}}]}' }} />
