  ...
  style.textContent = `
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 600px) {
      ...
      #ai-chat-input { font-size: 15px !important; }
      #ai-chat-name { font-size: 14px !important; }
      #ai-chat-sub { font-size: 11px !important; }
      #ai-chat-header { padding: 8px 10px !important; }
      #ai-chat-input-row { padding: 6px 8px !important; }
    }
